...
-- 4)Use a different JOIN so that all departments are listed.Show the team1, team2 and player for every goal scored by a player called Mario player LIKE 'Mario%'
